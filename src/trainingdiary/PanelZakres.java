...
{
    JLabel labelTerrarin = new MyLabel("Rodzaj terenu");
    MyComboBox comboTerrarin = new MyComboBox();
    String[] namesTerrarin = {"Bieżnia", "Teren", "Hala", "Asfalt"};
    ...
    public PanelZakres(JPanel panel) 
    {
        ...
        modifyComboTerrarin(comboTerrarin);
      ...
      public void modifyComboTName(MyComboBox combo)
    {
      ...
      public void modifyComboTerrarin(MyComboBox combo)
    {
        setButtonComboColors(combo, new Colors().getColorCompBackN());
        combo.setEditable(true);
        combo.addItems(namesTerrarin);
        combo.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    }
