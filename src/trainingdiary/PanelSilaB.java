...
public final class PanelSilaB 
{
    private MyComboBox combo = new MyComboBox();
    private Font font = combo.getFont();
    private JLabel labelKm = new MyLabel("Km przed");
    private JLabel labelKmSB = new MyLabel("Km siły biegowej");
    private JLabel labelTime = new MyLabel("Czas  [minuty]");
    ...
    private JSpinner spinnerKmSB = new JSpinner();
    ...
    public PanelSilaB(JPanel panel) 
    {
        ...
        new PanelMods().modifyTCount(spinnerKmSB);
                ...
                layout.createParallelGroup()
                    ...
                    (
                        layout.createSequentialGroup()
                                    ...
                                    (
                                        layout.createSequentialGroup()
                                                    .addComponent(labelTime).addGap(20)
                    ...
                    (
                        layout.createSequentialGroup()
                            .addComponent(labelKmSB, 350,350,350)
                            .addComponent(spinnerKmSB)
                            .addGap(20)
                    )
