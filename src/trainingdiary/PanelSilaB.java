...
public final class PanelSilaB implements WindowListener
{
    private MyComboBox combo = new MyComboBox();
    private Font font = combo.getFont();
    JLabel labelKm = new MyLabel("Km przed");
    JLabel labelKmSB = new MyLabel("Km siły biegowej");
    JLabel labelTime = new MyLabel("Czas  [minuty]");
//    JLabel labelMin = new MyLabel("[minuty]");
    ...
    JSpinner spinnerKmSB = new JSpinner();
