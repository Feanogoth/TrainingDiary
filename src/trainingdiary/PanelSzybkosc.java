...
public class PanelSzybkosc extends JFrame
{
    ...
    private JLabel labelDistanceSpeed = new MyLabel("Dystans szybkości [m]");
    private JSpinner spinnerDistanceSpeed = new JSpinner();
    ...
    public PanelSzybkosc(JPanel panel) 
    {
        ...
        new PanelMods().modifyTCount(spinnerDistanceSpeed);
